...
D=json.loads((R/'materials/pythagorean/content.json').read_text());L=D['lessons'];Q=D['questions'];N=len(Q);W,H=595.276,841.89
class Book:
...
b=Book('guide','三平方 ① 解説')
for l in L:
 b.page(l['title'],'対応する問題：'+ '・'.join(str(n) for n in l['questions'])+'。必要な辺・角を図でたどろう。')
