...
このレポートは**課題の整理**です。今回修正したのは、依頼された三平方の短辺への指示線と、直方体・取り出す三角形の対応だけです。下記A01〜A37は未修正です。円・三平方の公開・PR統合も行っていません。
...
詳細：[導線](navigation.md)／[数学Web](math.md)／[紙の新3単元](pdfs.md)／[紙の旧2単元](pdf-older.md)／[Pythonと使いやすさ](usability.md)。代表画像は同梱、全ページ画像は再生成可能な点検用中間物です。既存教材の内容・コードには今回の監査による修正を加えていません。
...
課題を表計算で整理する場合は [課題一覧CSV](issues.csv) を利用できます。全37件の状態は未修正です。
