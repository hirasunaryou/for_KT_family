...
**修正状況（第1回）**：その後の修正依頼により、A01・A28・A31・A32の4件を修正・検証しました。状態は「修正済み・確認用（未公開）」、残り33件は未修正です。[修正内容と検証記録](fixes-01.md) を参照してください。円・三平方を含め、公開・PR統合は行っていません。
...
課題を表計算で整理する場合は [課題一覧CSV](issues.csv) を利用できます。4件は修正済み・確認用（未公開）、残り33件は未修正です。
